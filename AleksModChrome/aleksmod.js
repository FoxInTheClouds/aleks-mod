...
function changeInterface(){
    var savedbuttonColor = chrome.storage.local.get("buttonColorValue");    
    ...
    var savedheaderColor = chrome.storage.local.get("headerColorValue");   
    ...
    var savedAltButtonColor = chrome.storage.local.get("altButtonColorValue");   
    ...
    var savedButtonFontColor =chrome.storage.local.get("buttonFontColorValue");   
    ...
    var savedAltButtonFontColor = chrome.storage.local.get("altButtonFontColorValue");   
    ...
    var savedCarouselButtonColor = chrome.storage.local.get("carouselButtonColorValue");   
    ...
    var savedFooterColor = chrome.storage.local.get("footerColorValue");   
    ...
    var savedFooterFontColor = chrome.storage.local.get("footerFontColorValue");   
    ...
    var savedcarouselColor = chrome.storage.local.get("carouselColorValue");   
...
setInterval(changeInterface, 10)
